## Criar a view costomers/index.php
...
Agora vamosimportar uma tabela e algusn dados gerados com a biblioteca faker para testes.

Abra o próximo item para fazer isso.
