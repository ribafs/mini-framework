...
class CustomersController
{
    ...
    {
		// View customers/index send request to Router, it request CustomersContoller/index, it request model Customers/getAllCustomers,
        ...
        $amount_of_customers = $Customers->getAmountOfCustomers();
    ...
    public function add()
    {
        ...
        if (isset($_POST['submit_add_customer'])) {
            // Instance new Model (Customers)
            $Customers = new CustomersModel();
            // do add() in model/Customers.php
            $Customers->add($_POST['name'], $_POST['email'],  $_POST['birthday']);
	        // where to go after Customers has been added
    ...
    {
		// View customers/index send request to Router, it request CustomersContoller/delete, it request model Customers/delete,
    ...
    public function update()
    {
        ...
        if (isset($_POST['submit_update_customer'])) {
            ...
            $Customers->update($_POST['name'], $_POST['email'],  $_POST['birthday'], $_POST['customer_id']);
        }
